...
const Loader = () => (
  <div className="w-full h-32 flex items-center justify-center bg-[#1f2326]">
    <div className="w-6 h-6 border-2 border-[#a855f7] rounded-full animate-spin border-t-transparent" />
  </div>
)
...
const TrialPageContent: React.FC = () => {
  return (
    <>
      ...
      <section
        id="trial-form"
        className="relative py-20 px-4 bg-gradient-to-br from-[#020204] via-[#1a1d20] to-[#020204] overflow-hidden"
      >
        {/* Background glows */}
        <div className="hidden md:block absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[#a855f7]/10 blur-[150px] rounded-full pointer-events-none animate-pulse-slow" />
        <div className="hidden md:block absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#6d28d9]/10 blur-[150px] rounded-full pointer-events-none animate-pulse-slow-reverse" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center mb-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-4">
            {[
              ...
              >
                <i className={`${icon} text-[#a855f7] text-xs`} />
                {label}
              </span>
            ))}
          </div>
      ...
      <section className="bg-[#1f2326] py-16 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            SMART 4K offers the best free IPTV trial in 2026. Submit your request and receive full access to 22,000+ live channels —
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            Looking for a free IPTV test before you commit? SMART 4K is rated the #1 IPTV service for reliability and 4K quality.
