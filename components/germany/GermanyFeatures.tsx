...
const GERMANY_FEATURES = [
  {
    ...
    description: 'Ein dedizierter Frankfurt-Edge-Server hält die Latenz unter 25 ms – egal ob du den Bundesliga-Topspiel-Samstag in Berlin schaust, einen Champions-League-Abend in München oder die Olympia-Highlights in Hamburg. Anti Freeze CDN lenkt Spitzenlast in Echtzeit um, sodass jeder Anstoß, jede Boxen-Stopp-Entscheidung und jeder Goldmedaillen-Moment pufferungsfrei in 4K HDR ankommt.',
    imageUrl: '/images/germany-coverage.jpg',
    altText: 'Zwei deutsche Bundesliga-Fans auf dem Sofa beim Live-Streaming eines 4K-HDR-Bundesliga-Spiels auf einem Smart TV – pufferungsfreies IPTV Deutschland Streaming auf ORCA 4K TV.',
    reverse: false
  },
  {
    title: 'Intelligenter Programmführer für den deutschen Sportkalender',
    description: 'Der ORCA 4K TV Programmführer kennt deine Woche – Bundesliga-Wochenende, Champions League dienstags und mittwochs, F1-Sonntage, DFB-Pokal-Mittwoch, Olympia-Highlights aus Mailand-Cortina. Live-Ticker, Sender-Sprünge, 7-Tage-Catch-Up-TV und KI-gestützte Suche („Was läuft jetzt?") für ARD, ZDF, RTL, ProSieben, Sat.1, Vox, Sport1 und Eurosport.',
