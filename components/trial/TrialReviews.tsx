...
const TrialReviews: React.FC = () => {
  return (
    <section className="py-20 bg-[#1f2326] relative overflow-hidden">
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#6d28d9]/10 rounded-full blur-[120px] -translate-y-1/2 pointer-events-none"></div>
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#a855f7]/10 rounded-full blur-[120px] translate-y-1/2 pointer-events-none"></div>

      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4 uppercase tracking-tight">
            IPTV Trial – <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6d28d9] to-[#a855f7]">What Users Say</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviewsRaw.map((review, i) => (
            <div
              key={i}
              className="bg-[#15171a] p-8 rounded-3xl border border-white/5 hover:border-[#a855f7]/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl group"
            >
              ...
              <div className="border-t border-white/5 pt-6 flex items-center justify-between">
                ...
                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-500 group-hover:text-white group-hover:bg-[#6d28d9] transition-all">
