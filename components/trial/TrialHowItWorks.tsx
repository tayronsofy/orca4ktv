      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4 uppercase tracking-tight">
            How It <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6d28d9] to-[#a855f7]">Works</span>
          </h2>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="hidden md:block absolute top-14 left-[calc(16.66%+2rem)] right-[calc(16.66%+2rem)] h-px bg-gradient-to-r from-[#6d28d9] to-[#a855f7] opacity-30 pointer-events-none" />

          {steps.map((step, i) => (
            <div key={i} className="text-center relative z-10">
              <div className="relative inline-flex items-center justify-center w-28 h-28 mb-6">
                <span className="absolute text-7xl font-black text-[#a855f7]/10 leading-none select-none">{step.number}</span>
                <div className="relative w-16 h-16 rounded-2xl bg-[#1f2326] border border-[#a855f7]/20 flex items-center justify-center shadow-lg">
                  <i className={`${step.icon} text-[#a855f7] text-xl`}></i>
                </div>
              </div>
