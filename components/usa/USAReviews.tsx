...
const reviewsRaw = [
    {
        text: "The NFL streams are flawless and the 4K movie categories look amazing on my TV. Setup took 5 minutes.",
        device: "Apple TV - New York",
    },
    {
        text: "The American support team replies incredibly fast. I had a small Firestick set up issue and they helped right away.",
        device: "Firestick - Texas",
    },
    {
        text: "Huge VOD library and a clean EPG showing all local US channels. Works great on both my iPhone and OLED TV.",
        device: "iOS + Smart TV - California",
    },
];
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
                        American viewers choose us for stability, extensive local channels, and fast support when setup help is needed.
                    </p>
                </div>
