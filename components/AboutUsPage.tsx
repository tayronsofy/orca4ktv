...
const AboutUsPage: React.FC<AboutUsPageProps> = ({ onBackToHome }) => {
  ...
  const missionImageUrl = "/images/orca4ktv-not-harder-scaled.png";
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center py-24 bg-gradient-to-br from-[#00050d] via-[#001a36] to-[#00050d] px-4 overflow-hidden">
      <SEO
        title="About Us - ORCA 4K TV - Our Vision & Mission"
        description="Learn about ORCA 4K TV's mission to revolutionize global TV streaming with 4K quality, anti-freeze technology, and 24/7 support."
      ...
      <div className="relative z-10 w-full max-w-4xl text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-black mb-8 leading-[0.9] tracking-tighter text-white drop-shadow-[0_20px_20px_rgba(0,0,0,0.8)]">
          ABOUT <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] via-white to-[#00E5FF] bg-[length:200%_auto] animate-shimmer">ORCA 4K TV</span>
        </h1>

        <p className="text-lg md:text-xl text-gray-400 mb-12 font-medium max-w-3xl mx-auto drop-shadow-lg leading-relaxed">
          ORCA 4K TV was founded with a singular ambition: redefining your home entertainment experience. We are dedicated to delivering borderless access to premium television networks, powered by industry-leading stability and visual excellence.
        </p>
      </div>

      <div className="relative z-10 w-full max-w-5xl mx-auto mt-16 space-y-20 px-4 md:px-0">
        {/* Section 1: Our Mission */}
        <div className="flex flex-col md:flex-row items-center gap-12 bg-[#001f3f]/60 border border-white/5 rounded-3xl p-8 md:p-12 shadow-xl backdrop-blur-md">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12 bg-[#001f3f]/60 border border-white/5 rounded-3xl p-8 md:p-12 shadow-xl backdrop-blur-md">
          <div className="md:w-1/2 text-center md:text-left">
            <h2 className="text-3xl font-black text-white mb-4">Elite Programming Selection & Performance</h2>
            <p className="text-gray-300 text-lg leading-relaxed">
              Beyond simply offering channels, ORCA 4K TV curates an elite digital library. We guarantee flawless transmission backed by our proprietary anti-freeze protocols and a robust 99.9% uptime SLA, making buffering a relic of the past on any device.
            </p>
          </div>
          <div className="md:w-1/2 flex justify-center">
            <img
        ...
        <div className="text-center py-12 px-8 bg-[#001f3f]/60 border border-white/5 rounded-3xl shadow-xl backdrop-blur-md">
          <h2 className="text-3xl font-black text-white mb-6">The ORCA 4K TV Advantage</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            <div className="flex flex-col items-center">
              <i className="fas fa-globe-americas text-5xl text-[#00E5FF] mb-4"></i>
