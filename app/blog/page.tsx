...
export const metadata: Metadata = {
  title: 'IPTV Blog 2026 - Streaming Guides & Tutorials | ORCA 4K TV',
  description: 'In-depth IPTV guides, 4K streaming tutorials, Firestick + Smart TV setup walkthroughs, and reviews. Updated weekly by the ORCA 4K TV Editorial Team.',
