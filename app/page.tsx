...
export const metadata: Metadata = {
  title: 'Orca 4K TV IPTV Subscription — 22,000+ Live Channels in 4K HDR',
  description: 'Premium IPTV subscription with 22,000+ live channels, on-demand movies, 4K HDR streaming, AES-256 encryption, smart EPG guide, multi-device compatibility, and 24/7 customer support. Buffer-free streaming on Firestick, Smart TV, Android, iOS & Apple TV.',
  ...
  openGraph: {
    title: 'Orca 4K TV IPTV Subscription — 22,000+ Live Channels in 4K HDR',
    description: 'Premium IPTV streaming service: live channels, on-demand movies, 4K HDR, AES-256 encrypted secure streaming, smart EPG guide, instant activation, multi-device compatibility, 24/7 customer support.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Orca 4K TV IPTV Subscription — 22,000+ Live Channels in 4K HDR',
    description: 'IPTV streaming service with 4K HDR, AES-256 encryption, multi-device support, 24/7 customer support, and instant activation.',
